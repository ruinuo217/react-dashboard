    ...
    <div className="bg-white rounded-xl border border-gray-100 p-5">
      ...
      <ResponsiveContainer width="100%" height={280}>
        <PieChart>
          ...
          <text x="35%" y="47%" textAnchor="middle" dominantBaseline="central" className="text-xl font-bold fill-gray-900" style={{ fontSize: 22, fontWeight: 'bold' }}>
            {total.toLocaleString()}
          </text>
          <text x="35%" y="57%" textAnchor="middle" dominantBaseline="central" className="fill-gray-400" style={{ fontSize: 12 }}>
            總車輛數
          </text>
          <Tooltip
